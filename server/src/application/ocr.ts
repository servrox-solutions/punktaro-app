...
export async function createInvoice(file: Buffer): Promise<OcrReceipt | OcrReceiptError> {
...
export function isError(response: OcrReceipt | OcrReceiptError): response is OcrReceiptError {
